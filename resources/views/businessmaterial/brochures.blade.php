...
<body  class="bodddy">
    <div style="margin-top: -112px;"
     class="container-fluid bg-dark contn text-center">
        <p class="BC">Brochures</p>
        <p class="let">Let your Brochures do the talking with special finishes and unique sizes guaranteed to make an impression.</p>
    </div>

    <div class="text-center">
        <p class="sbc mb-0 mt-3">Shop Brochures</p>
        <p class="you">You can’t go wrong.We start at premium Brochures and go all the way to extra fancy.
