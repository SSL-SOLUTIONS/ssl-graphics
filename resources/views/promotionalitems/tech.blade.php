...
<body  class="bodddy">
    <div style="margin-top: -112px;"
     class="container-fluid bg-dark contn text-center">
        <p class="BC">Tech (USB,Accessories)</p>
        <p class="let">Let your Tech (USB,Accessories) do the talking <br> with special finishes and unique sizes <br>
            guaranteed to make an
            impression.</p>
    </div>

    <div class="text-center">
        <p class="sbc mb-0 mt-3">Shop Tech (USB,Accessories)</p>
        <p class="you">You can’t go wrong. We start at premium Tech (USB,Accessories) and go all the way to extra fancy.
