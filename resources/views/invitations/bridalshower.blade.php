...
<body  class="bodddy">
    <div style="margin-top: -112px;"
     class="container-fluid bg-dark contn text-center">
        <p class="BC">Bridal Shower</p>
        <p class="let">Let your Bridal Shower do the talking <br> with special finishes and unique sizes <br>
            guaranteed to make an
            impression.</p>
    </div>

    <div class="text-center">
        <p class="sbc mb-0 mt-3">Shop Bridal Shower</p>
        <p class="you">You can’t go wrong. We start at premium Bridal Shower and go all the way to extra fancy.
